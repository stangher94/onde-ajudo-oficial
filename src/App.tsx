...
export default function App() {
  ...
  return (
    <div 
      ...
      className="font-sans min-h-screen w-screen flex justify-center items-stretch overflow-hidden relative"
    >
      {/* Container Principal */}
      <div 
        style={{ backgroundColor: '#faf5f0' }} 
          ...
          >
            ...
            <div className="w-full flex-1 flex flex-col items-center justify-center pt-12">
              ...
              >
                ...
                <g transform="translate(9, 12.4) scale(0.55)" className="animate-heart-beat">
                  <path 
