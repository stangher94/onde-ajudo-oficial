...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Animação CSS ajustada com os eixos exatos de centralização do logo
  ...
  return (
    <div className="bg-[#faf5f0] font-sans h-screen w-screen flex justify-center items-stretch overflow-hidden relative">
      
      {/* Contêiner da Aplicação preenchendo 100% da viewport */}
      <div className="w-full max-w-md bg-[#faf5f0] h-full flex flex-col relative overflow-hidden">
        
        {/* TELA DE CARREGAMENTO CENTRALIZADA (COM FUNDO CREME #faf5f0 E PIN RE-ALINHADO) */}
        {carregando ? (
          <div className="flex-1 flex flex-col items-center justify-center p-6 bg-[#faf5f0] text-center select-none animate-fadeIn">
            
            {/* Ícone com Coração Centralizado com Precisão */}
            <div className="w-44 h-44 mb-6 relative flex items-center justify-center">
              <svg viewBox="0 0 40 40" className="w-full h-full drop-shadow-xs" xmlns="http://www.w3.org/2000/svg">
                {/* Gotinha do Pin */}
                <path d="M20 3C13.37 3 8 8.37 8 15c0 9 12 21 12 21s12-12 12-21c0-6.63-5.37-12-12-12z" fill="#ceaa82" />
                
                {/* Coração Deslocado e Centralizado na Cruz de Referência */}
                <g transform="translate(0, 0.5)" className="animate-heart-beat">
            ...
            {/* Tipografia Oficial Centralizada */}
            <h1 className="font-logo font-black text-4xl tracking-tighter text-black mb-3 leading-none">
              Onde Ajudo?
            </h1>
            
            <p className="font-logo font-medium text-sm text-slate-800 tracking-wide animate-pulse">
          ...
          <>
            ...
            {/* FOOTER FIXADO SEM FAIXA PRETA */}
            <footer className="w-full bg-[#3E3327] border-t border-[#524435] px-4 py-3.5 text-center shrink-0">
